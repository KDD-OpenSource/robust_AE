...
class tsne_latent:
    def __init__(
        self, eval_inst: evaluation, name: str = "tsne_latent", tsne_dim = 3
    ):
        self.name = name
    ...
    def evaluate(self, dataset, algorithm):
        ...
        if self.tsne_dim == 3:
            ...
            angle = 3
            ani = animation.FuncAnimation(fig, rotate, frames=np.arange(0,360,
                angle), interval = 50)
            ani.save(os.path.join(self.evaluation.run_folder,'tsne_latent_3d_rotate.gif'),
